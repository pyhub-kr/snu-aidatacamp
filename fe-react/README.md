...
웹서비스는 https://aidatacamp.pyhub.kr 페이지를 통해서 이용하실 수 있구요. 회원가입 및 로그인도 지원합니다.

+ 유저마다 1개의 채팅방 만을 만들 수 있도록 제약을 걸어뒀구요.
+ https://aidatacamp.pyhub.kr/example/chat/ 페이지 통해서 채팅을 하실 수도 있고, 아래에서 소개하는 API를 통해서도 동일한 대화내역으로 채팅을 할 수 있습니다.
+ https://aidatacamp.pyhub.kr/example/edit/ 페이지 통해서 시스템 프롬트를 수정할 수 있습니다.
+ 대화내역은 서버의 데이터베이스에 자동 저장되고 있고, 대화방 설정을 수정하면, 대화내역은 자동으로 삭제됩니다.
